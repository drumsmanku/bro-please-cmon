    ...
    <article className='flex flex-col  snap-center bg-[#292929] rounded-lg items-center space-y-4 flex-shrink-0 mt-10 w-[500px] md:w-[600px] xl:w-[900px] p-10 opacity-60 hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden'>
        <motion.img 
         ...
         viewport={{once:true}}
          ...
          src="https://drive.google.com/uc?export=view&id=1ZklW0DvEkl4CRZnUSoAC2etcjbZ4ToUu" alt="" />
          <div className='px-0 md:px-10'>
            <h4 className='text-2xl font-light'>I do nothing</h4>
            <div className='flex space-x-2 my-1'>
              {/* tech used */}
              <img className='h-10 w-10 rounded-full object-contain ' src="https://drive.google.com/uc?export=view&id=1xSQxmP9Ny7Tty3lIHSx5axQGIJmvZBFP" alt="" />
              <img className='h-10 w-10 rounded-full object-contain' src="https://drive.google.com/uc?export=view&id=1xSQxmP9Ny7Tty3lIHSx5axQGIJmvZBFP" alt="" />
              <img className='h-10 w-10 rounded-full object-contain ' src="https://drive.google.com/uc?export=view&id=1xSQxmP9Ny7Tty3lIHSx5axQGIJmvZBFP" alt="" />
              
            </div>
            <p className='uppercase py-3 text-gray-400'>dates..</p>
